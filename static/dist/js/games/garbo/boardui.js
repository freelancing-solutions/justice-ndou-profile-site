...
function InitializeBackgroundEngine() {
    ...
    if (g_backgroundEngine == null) {
        ...
        try {
            g_backgroundEngine = new Worker("/static/dist/js/games/garbo/garbochess.js");
    ...
    for (y = 0; y < 8; ++y) {
        for (x = 0; x < 8; ++x) {
            ...
            if (pieceName != null) {
                ...
                img.style.backgroundImage = "url('/static/dist/img/sprites.png')";
                ...
                $(divimg).mousedown(function(e) {
                    if (g_selectedPiece === null) {
                        ...
                        e.stopPropagation();
                        g_selectedPiece = this;
                        g_selectedPiece.style.backgroundImage = "url('/static/dist/img/transpBlue50.png')";
